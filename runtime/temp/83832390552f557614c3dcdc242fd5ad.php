<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\WWW\Property\public/../application/admin/view/default/house\edit.html";i:1534040414;s:82:"D:\phpStudy\WWW\Property\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url('House/edit'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

	<div class="form-item">
		<div class="controls">
			<select name="type" id="">
				<option <?php echo !empty($house['type']) && $house['type']==0?'selected':''; ?> value="0">出租</option>
				<option <?php echo !empty($house['type']) && $house['type']==1?'selected':''; ?> value="1">出售</option>
			</select>
		</div>
	</div>
	...
	<div class="form-item">
		...
		<div class="controls">
			<input type="text" class="text input-large" name="title" value="<?php echo $house['title']; ?>">
			<input type="hidden" class="text input-large" name="id" value="<?php echo $house['id']; ?>">
		</div>
	</div>
	<div class="form-item">
		<label class="item-label">价格<span class="check-tips"></span></label>
		<div class="controls">
			<input type="text" class="text input-large" name="price" value="<?php echo $house['price']; ?>">
		</div>
	</div>
	...
	<div class="form-item">
		...
		<div class="controls">
			<input type="text" class="text input-large" name="tel" value="<?php echo $house['tel']; ?>">
		</div>
	</div>
	...
	<div class="form-item">
		...
		<div class="controls">
			<label><input type="radio"  <?=$house['status']==0?'checked':''?> name="status" value="0">不显示</label>
			<label><input type="radio"  <?=$house['status']==1?'checked':''?> name="status" value="1">显示</label>
		</div>
	</div>
	...
	<div class="form-item">
		...
		<div class="controls">
			<input type="datetime-local" class="text input-large" name="rental_time" value="<?=date('Y-m-d\TH:i:s')?>">
		</div>
	</div>
	...
	<div class="form-item cf">
		...
		<div class="controls">
			<input type="datetime-local" name="end_time" class="text time" value="<?=date('Y-m-d\TH:i:s')?>" placeholder="请选择时间">
		</div>
	</div>
	...
	<div class="form-item">
		...
		<div class="controls">
			<textarea name="description"  cols="55" rows="8"><?php echo $house['description']; ?></textarea>
		</div>
	</div>
	...
	<div class="form-item cf">
		...
		<div class="controls">
			<label class="textarea">
				<textarea name="content"><?php echo $house['content']; ?></textarea>

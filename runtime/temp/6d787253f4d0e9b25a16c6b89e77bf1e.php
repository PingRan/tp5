<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\Property\public/../application/admin/view/default/repair\edit.html";i:1533783968;s:82:"D:\phpStudy\WWW\Property\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url('Repair/edit'); ?>" method="post" class="form-horizontal">
		<div class="form-item">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="tel" value="<?php echo $repair['tel']; ?>">
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<label class="textarea">
					<textarea name="content"><?php echo $repair['content']; ?></textarea>

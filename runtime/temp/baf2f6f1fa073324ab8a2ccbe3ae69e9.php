<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\WWW\Property\public/../application/home/view/default/index\house.html";i:1534065193;s:81:"D:\phpStudy\WWW\Property\public/../application/home/view/default/public\base.html";i:1534054270;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img width="250px" src="<?php echo $v['imgUrl']['path']; ?>" alt="...">
                                <div class="caption">
                                    <h4><?php echo $v['title']; ?></h4>
                                    <p class="zushouInfo"><?php echo $v['description']; ?></p>
                                    <p class="text-danger"><?php echo $v['price']; ?>元/月</p>
                                    <p><a href="<?php echo url('index/houseDetail',array('id'=>$v['id'])); ?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                </div>
                            </div>
                        </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    ...
                    <div class="row">
                        <?php if(!(empty($listShou) || (($listShou instanceof \think\Collection || $listShou instanceof \think\Paginator ) && $listShou->isEmpty()))): if(is_array($listShou) || $listShou instanceof \think\Collection || $listShou instanceof \think\Paginator): $i = 0; $__LIST__ = $listShou;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shou): $mod = ($i % 2 );++$i;?>
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img width="250px;" src="<?php echo $shou['imgUrl']['path']; ?>" alt="...">
                                <div class="caption">
                                    <h4><?php echo $shou['title']; ?></h4>
                                    <p class="zushouInfo"><?php echo $shou['description']; ?></p>
                                    <p class="text-danger"><?php echo $shou['price']; ?>元/月</p>
                                    <p><a href="<?php echo url('index/shouDetail',array('id'=>$shou['id'])); ?>" class="btn btn-danger">详细信息</a> </p>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; endif; else: echo "" ;endif; endif; ?>

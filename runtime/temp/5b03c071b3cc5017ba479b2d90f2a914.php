<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\Property\public/../application/admin/view/default/house\index.html";i:1534038421;s:82:"D:\phpStudy\WWW\Property\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="cf">
		<a class="btn" href="<?php echo url('House/add'); ?>">新 增</a>
		<button id="del" class="btn ajax-post confirm" url="<?php echo url('del'); ?>" target-form="ids">删 除</button>
	...
	<div class="data-table table-striped">
		<table>
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$house): $mod = ($i % 2 );++$i;?>
					<tr>
						<td><input class="ids row-selected" type="checkbox" name="" id="" value="<?php echo $house['id']; ?>"> </td>
						<td><?php echo $house['id']; ?></td>
						<td><?php echo !empty($house['type'])?'出售':'出租'; ?></td>
						<td><img width="150px" src="<?php echo $house['imgUrl']['path']; ?>"></td>
						<td><?php echo $house['title']; ?></td>
						<td><?php echo $house['price']; ?></td>
						<td><?php echo $house['tel']; ?></td>
                        <td><?php echo $house['rental_time']; ?></td>
						<td><?php echo $house['end_time']; ?></td>
						<td><?php echo $house['status']; ?></td>
						<td>
							<a title="编辑" href="<?php echo url('edit?id='.$house['id']); ?>">编辑</a>
							<a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$house['id']); ?>">删除</a>
						</td>
					</tr>

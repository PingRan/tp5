<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\Property\public/../application/home/view/default/index\service.html";i:1534068834;s:81:"D:\phpStudy\WWW\Property\public/../application/home/view/default/public\base.html";i:1534054270;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="/homestatic/image/3.png" width="100%" />
        </div>
        <div class="blank"></div>
        <div class="container">
            <ul class="list-group fuwuList">
                ...
                <li class="list-group-item"><a href="<?php echo url('index/owner'); ?>" class="text-info"><span class="iconfont">&#xe605;</span>业主认证</a></li>
                <li class="list-group-item test"><a href="javascript:;" class="text-success"><span class="iconfont">&#xe602;</span>在线缴费</a></li>
                <li class="list-group-item"><a href="<?php echo url('index/shenghuo'); ?>" class="text-warning"><span class="iconfont">&#xe601;</span>生活贴士</a></li>
                <li class="list-group-item"><a href="<?php echo url('article/lists',array('category'=>49)); ?>" class="text-primary"><span class="iconfont">&#xe600;</span>关于我们</a></li>
            </ul>
        </div>
    </div>

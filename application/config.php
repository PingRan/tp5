...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '_M:L/FOk}RVJZUb`$m?Wgd6f54CH-l1Khp^{nj.x', //默认数据加密KEY
	'data_cache_key'=> '_M:L/FOk}RVJZUb`$m?Wgd6f54CH-l1Khp^{nj.x',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'_M:L/FOk}RVJZUb`$m?Wgd6f54CH-l1Khp^{nj.x', //加密KEY
